...
file3_path="FinaL1.xlsx"
output_path = "merged_file3.xlsx"
...
try:
    ...
    df3=pd.read_excel(file3_path,usecols=["Levenstein_distance"])
    ...
    print(f"Columns from {file1_path} and {file2_path} and {file3_path} merged successfully into {output_path}")
